export const en = {
    ...
    changePasswordHint: 'Enter your current password and set a new sign-in password.',
    ...
    resetPasswordHint: 'Set a new sign-in password for {user}.',
    resetPasswordConfirm: 'Reset {user}\'s sign-in password to a random password?',
    confirmResetPassword: 'Confirm reset',
    generatedPassword: 'Random password',
    resetPasswordSuccessMessage: 'Password reset for {user}. New password:',
    copyNewPassword: 'Copy new password',
    resetPasswordGeneratedHint: 'Copy it now and send it to the user. It will not be shown again after closing this dialog.',
    ...
    planGuard: 'Dual cycle limits',
    quotaHint: 'Requests are blocked when either cycle is exhausted',
    ...
    keyDetails: 'Details',
    keyPriority: 'Key priority (lower first)',
    keyPriorityShort: 'Priority',
    inputRateShort: 'Input',
    cacheWriteRateShort: 'Cache write',
    cacheReadRateShort: 'Cache read',
    outputRateShort: 'Output',
    ban: 'Ban',
    banning: 'Banning...',
    unban: 'Unban',
    unbanning: 'Unbanning...',
